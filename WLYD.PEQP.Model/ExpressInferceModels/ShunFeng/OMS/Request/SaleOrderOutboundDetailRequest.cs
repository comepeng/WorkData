...
using Compeng.OMS.BusinessModel.Messages.SF.OMS.Request;

namespace Compeng.OMS.BusinessModel.InterfaceModels.SF.OMS.Request
{
    /// <summary>
    /// 出库单明细回传
    /// </summary>
    ...
    /// </summary>
    [Serializable]
    public class SaleOrderOutboundDetail /*: RequestModel*/
    {
    ...
    public class OrderProductDetail
    {
        ...
        public string ErpOrderLineNum { get; set; }
