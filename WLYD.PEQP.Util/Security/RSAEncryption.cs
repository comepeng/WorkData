...
namespace Compeng.PEQP.Util.Security
{
    ...
    public static class RSAEncryption
    {
        ...
        /// <returns></returns>
        public static string Encrypt(string publicKey, string plainText, Encoding encode = null)
        {
            encode = encode == null ? Encoding.UTF8 : encode;
            RSA rsa = CreateRsaFromPublicKey(publicKey);
            var plainTextBytes = encode.GetBytes(plainText);
        ...
        /// <param name="encode"></param>
        /// <returns></returns>
        public static string Decrypt(string privateKey, string cipherText, Encoding encode = null)
        {
            encode = encode == null ? Encoding.UTF8 : encode;
          ...
          var  plainTextBytes = rsa.Decrypt(cipherBytes, RSAEncryptionPadding.Pkcs1);
           return encode.GetString(plainTextBytes);
